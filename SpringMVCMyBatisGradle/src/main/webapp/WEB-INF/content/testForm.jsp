 ...
 <body>    
	...
	<div class="row">
        ...
        <ul>
            ...
            <li>
                <span><i class="icon-folder-open"></i> 订单</span> <a href=""></a>
                <ul>
                    <li>
                        <span><i class="icon-leaf"></i> 一级节点2_1</span> <a href=""></a>
                    </li>
		...
		<table border="1">
	<tr>
		<th>封面</th><th>书名</th><th>价格</th>
	</tr>
	<c:forEach items="${requestScope.good_list }" var="book">
		<tr>
			<td><img src="images/${good.image }" height="60"></td>
			<td>${good.name }</td>
			<td>${good.price }</td>
		</tr>
	</c:forEach>
