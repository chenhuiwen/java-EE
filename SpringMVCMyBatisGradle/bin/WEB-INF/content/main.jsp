					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="Usercartlist?user_sn=${sessionScope.user.id }" >购物车</a>
									
								</li>
								<li>
									<a href="order?user_sn=${sessionScope.user.id }">订单</a>
								</li>
								<li>
									<a href="#">评价</a>
								</li>
								<li>
									<a href="collectlist?user_sn=${sessionScope.user.id }">收藏</a>
